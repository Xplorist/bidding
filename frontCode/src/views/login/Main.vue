            ...
            <div class="pri_loginBox">
              ...
              <div v-if="nowStatus == 'login'" class="login_content">
                ...
                >
                  <el-form-item label="用戶" class="name" prop="name">
                    <el-input v-model="formLogin.name" placeholder="請輸入您的用戶名"></el-input>
                  </el-form-item>
                ...
                <div class="opreation">
                  ...
                  <div class="forget_register">
                    <router-link to @click.native="changeStatue('forgot')">忘記密碼</router-link>
              ...
              <div v-else-if="nowStatus == 'forgot'" class="forgot_content">
                ...
                >
                  <el-form-item class="account" prop="account">
                    <el-input v-model="formForgot.account" placeholder="請輸入您的賬號"></el-input>
                    <el-button
                      :disabled="getCodeFlag"
                      @click="getCode()"
                    >{{getCodeFlag ? '已發送('+countdown+')':'發送驗證碼'}}</el-button>
                    <span v-show="getCodeFlag" class="tip">已發往{{formForgot.email}}</span>
                  </el-form-item>
                  <el-form-item class="verifCode" prop="verifCode">
                    <el-input v-model="formForgot.verifCode" placeholder="請輸入驗證碼"></el-input>
                ...
                <div class="opreation">
                  <div></div>
                  <div class="forget_register">
                    <router-link to @click.native="changeStatue('login')">返回</router-link>
                  </div>
                </div>
              ...
              <div v-else class="alter_content">
                ...
                <div class="opreation">
                  <div></div>
                  <div class="forget_register">
                    <router-link to @click.native="changeStatue('forgot')">返回</router-link>
                  </div>
                </div>
      ...
      login_user_info(username)
        .then(res => {
          if (res.code === "1") {
            ...
            // 查詢頭像信息
            console.log(res.t.send_recv_type)
