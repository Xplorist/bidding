            ...
            <div class="quoteInfo">
              ...
              <div class="qu_content">
                <table class="tbSec" id="tbSec">
                  ...
                  <tr v-for="(item, index) in slav_list" :key="item.part_doc_file_pkid">
                    <td>{{index+1}}</td>
          ...
          <div class="bid-mainSec" id="bid-mainSec">
            ...
            <div class="annotation" id="annotation">
              ...
              <div class="an_content">
                <p>
                  <span>1.</span>可單個零件報價，若是成套模治檢具零件數量巨大，可採用成套模治檢具報價。
                </p>
                <p>
                  <span>2.</span>模治檢具加工涉及到輔助材料/組裝費/運費等不能歸屬的，可在零件名中填其它，報出金額即可。
                </p>
                <p>
                  <span>3.</span>報價需接單方權限主管核准后視為加工協議達成，接單方依系統訂單標書按要求加工、按期按質交貨等。
                </p>
                <p>
                  <span>4.</span>報價單報價均為未稅價。
                </p>
              </div>
            </div>
          </div>
