<template>
  <div id="main">
    <div class="main_title">新用戶</div>
    <!-- 表格 -->
    <table class="table-list" style="width:100%; text-align:center; border-collapse:collapse;">
      <tr>
        <th style="min-width: 80px;">
          <el-checkbox v-model="checkedAll" @change="changeCheckedAll" style="margin-right: 10px;"></el-checkbox>全選
        </th>
    ...
    <!-- 按鈕 -->
    <div v-show="tableData.length > 0" class="operaBtn">
      <div
        class="pass"
    ...
    <div v-show="tableData.length <= 0" style="text-align:center;margin-top:20px;">暫無需要處理的申請</div>
    <!-- 彈框 -->
      ...
      <div class="table-detail">
        <table>
          ...
          <tr>
            ...
            <td>
              ...
              <span
                style="color:#0092FF"
              >【{{detailData.send_recv_type == 'recv' ? '接單方' : '發單方'}}】</span>
            </td>
          </tr>
          <tr>
            <td>賬號名稱</td>
        ...
        <table>
          ...
          <tr v-if="detailData.send_recv_type=='recv'">
            ...
            <td>
              <span
                v-for="item in detailData.recv_range_list"
                :key="item.pkid"
              >{{item.name}}&nbsp;&nbsp;</span>
            </td>
          </tr>
