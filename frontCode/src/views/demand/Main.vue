  ...
  <div id="main">
    ...
    <div class="project">
      ...
      <div class="details">
        ...
        <!-- 訂單列表 -->
        <div>
          <div class="orderList" v-for="(item, index) in orderList" :key="item.pkid">
            <div class="list_left">
              ...
              <div class="left_info2">
                <div class="unitNumber">{{item.unitNumber || 0}}個單位已參與</div>
                <!-- <div>
            ...
            <div class="list_right">
              ...
              <div class="right_info">
                ...
                <div
                  class="operation"
                  @click="item.dropDownFlag=!item.dropDownFlag, getDropItem(item.statusClass, index)"
                >
                  操作
                  <img src="../../assets/imgs/demand/arrow_main.png" alt />
                  <!-- 下拉框 -->
                  <div class="dropDown" v-show="item.dropDownFlag && item.operationList.length">
                    <span
